...
/***/ (() => {
  ...
  var updateArticleForm = document.getElementById('updateArticleForm'); // defenim lista de date
  ...
  if (updateArticleForm) {
    ...
    /** @type {HTMLInputElement}  titleInput*/
    var titleInput = updateArticleForm.querySelector('#titleInput');
    /** @type {HTMLTextAreaElement}  descriptionInput*/
  
    var descriptionInput = updateArticleForm.querySelector('#descriptionInput');
    /** @type {HTMLSelectElement}  categoryInput*/
  
    var categoryInput = updateArticleForm.querySelector('#categoryInput');
    /** @type {HTMLSelectElement}  userInput*/
  
    var userInput = updateArticleForm.querySelector('#userInput');
    /** @type {HTMLInputElement}  imageInput*/
  
    var imageInput = updateArticleForm.querySelector('#imageInput');
    /** @type {HTMLImageElement}  imagePreview*/
  
    var imagePreview = updateArticleForm.querySelector('#imagePreview');
    ...
    var form = document.getElementById('updateArticleForm');
    form.addEventListener('submit', validate);
